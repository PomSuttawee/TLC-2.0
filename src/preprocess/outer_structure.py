...
def process_tlc_paper(image: np.ndarray, crop: bool = True, transform : bool = True) -> np.ndarray:
    """
    ...
    Args:
        ...
        transform (bool, optional): Whether to apply a perspective transform. Defaults to False.
